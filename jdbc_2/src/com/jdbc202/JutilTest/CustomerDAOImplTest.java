package com.jdbc202.JutilTest;

import com.jdbc201.util.JDBCUtils;
import com.jdbc202.bean.Customer;
import com.jdbc202.dao.CustomerDAOImpl;
...
public class CustomerDAOImplTest {
    ...
    public void testInsert() {
        ...
        try {
            ...
            Customer customer = new Customer(7, "李玟", "liwen@123.com", new java.sql.Date(time));
    ...
    public void testUpdate() {
        ...
        try {
            ...
            Customer customer = new Customer(22, "李玟", "liwen@123.com", new java.sql.Date(time));
