...
public abstract class BaseDAO<T> {
    ...
    //获取当前BaseDAO的子类继承的父类中的泛型, 在继承BaseDAO后实例化时,就会自动导入clazz
    {
        Type genericSuperclass = this.getClass().getGenericSuperclass();// 获取到CustomerDAOImpl的父类
    ...
    //去除了传入bean泛类, 没了泛类参数,此方法就不再是泛型方法,只是return泛类结果
    //去除了传入Class<T clazz参数, 代码中要知道使用是什么bean类,所以在BaseDAO代码块中动态获取
